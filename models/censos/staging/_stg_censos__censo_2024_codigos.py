...
def _get_table_path(table_name):
    config = load_yaml_config('models/censos/sources/_src_censo_2024__codigos.yml')
...
def stg_censos__censo_2024_codigos_regiones():
...
def stg_censos__censo_2024_codigos_provincias():
...
def stg_censos__censo_2024_codigos_comunas():
