...
`Fact tables`: Almacenan eventos de negocio cuantitativos y medibles (por ejemplo: ventas, clics, transacciones). Suelen ser largas y estrechas.

`Dimension tables`: Dan contexto descriptivo (por ejemplo: cliente, producto, ubicación). Suelen ser anchas, con diversos atributos de texto.
